...
return [
    ...
    [
        ...
        'usage' => 'C',
        'conditionalStatement' => 'Required if the image is reconstructed from a system with multiple X-Ray sources and Multi-energy CT Acquisition (0018,9361) is NO or is absent.',
        'moduleType' => 'Multi-frame',
    ],
    [
        'ciodId' => 'enhanced-ct-image',
    ...
    [
        ...
        'macroId' => 'pixel-measures',
        'usage' => 'C',
        'conditionalStatement' => 'Required if Derivation Image Functional Group (C.7.6.16.2.6) is not present and the Frame of Reference is defined in the patient-relative Reference Coordinate System. May be present otherwise if the Frame of Reference is defined in the patient-relative Reference Coordinate System. See Section\xa0A.51.5.1',
        'moduleType' => 'Multi-frame',
    ],
    [
        'ciodId' => 'segmentation',
    ...
    [
        ...
        'macroId' => 'plane-position-slide',
        'usage' => 'C',
        'conditionalStatement' => 'Required if Derivation Image Functional Group (C.7.6.16.2.6) is not present and the Frame of Reference is defined in the Slide Coordinate System and Dimension Organization Type (0020,9311) is not TILED_FULL. May be present otherwise if the Frame of Reference is defined in the Slide Coordinate System. See Section\xa0A.51.5.1.',
        'moduleType' => 'Multi-frame',
    ],
    [
        'ciodId' => 'segmentation',
        'macroId' => 'derivation-image',
        'usage' => 'C',
        'conditionalStatement' => 'Required if Pixel Measures (C.7.6.16.2.1) or either Plane Position (Patient) (C.7.6.16.2.3) or Plane Orientation (Patient) (C.7.6.16.2.4) (if the Frame of Reference is defined in the patient-relative Reference Coordinate System), or Plane Position (Slide) (C.8.12.6.1) (if the Frame of Reference is defined in the Slide Coordinate System) Functional Groups are not present. May be present otherwise. See Section\xa0A.51.5.1',
        'moduleType' => 'Multi-frame',
    ],
    [
        'ciodId' => 'segmentation',
        'macroId' => 'frame-content',
        'usage' => 'C',
        'conditionalStatement' => 'Required if not empty. Shall not be used as a Shared Functional Group.',
        'moduleType' => 'Multi-frame',
    ],
    [
        'ciodId' => 'segmentation',
        ...
        'usage' => 'C',
        'conditionalStatement' => 'Required if Dimension Organization Type (0020,9311) is not TILED_FULL',
        'moduleType' => 'Multi-frame',
    ],
    [
    ...
    [
        ...
        'macroId' => 'plane-position-patient',
        'usage' => 'C',
        'conditionalStatement' => 'Required if Ultrasound Acquisition Geometry (0020,9307) has a value of PATIENT. May be present otherwise. See Section\xa0A.59.4.1.2.',
        'moduleType' => 'Multi-frame',
    ],
    [
        'ciodId' => 'enhanced-us-volume',
    ...
    [
        ...
        'usage' => 'C',
        'conditionalStatement' => 'Required if Intravascular Acquisition (0018,3100) equals MEASURED or Presentation Intent Type (0008,0068) equals FOR PRESENTATION.',
        'moduleType' => 'Multi-frame',
    ],
    [
        'ciodId' => 'intravascular-optical-coherence-tomography-image',
    ...
    [
        ...
        'macroId' => 'plane-position-slide',
        'usage' => 'C',
        'conditionalStatement' => 'Required if the Frame of Reference is defined in the Slide Coordinate System and Dimension Organization Type (0020,9311) is not TILED_FULL. May be present otherwise if the Frame of Reference is defined in the Slide Coordinate System.',
        'moduleType' => 'Multi-frame',
    ],
    [
        'ciodId' => 'parametric-map',
    ...
    [
        'ciodId' => 'enhanced-rt-image',
        'macroId' => 'rt-image-frame-general-content',
        'usage' => 'M',
        'conditionalStatement' => null,
        'moduleType' => 'Multi-frame',
    ],
    [
        'ciodId' => 'enhanced-rt-image',
        'macroId' => 'rt-image-frame-imaging-device-position',
        'usage' => 'M',
        'conditionalStatement' => null,
        'moduleType' => 'Multi-frame',
    ],
    [
        'ciodId' => 'enhanced-rt-image',
        'macroId' => 'rt-image-frame-radiation-acquisition-parameters',
        'usage' => 'C',
    ...
    [
        'ciodId' => 'enhanced-rt-image',
        'macroId' => 'rt-image-frame-context',
        'usage' => 'C',
        'conditionalStatement' => 'Required if the SOP Instance was created for the purpose of controlling the treatment position of the patient.',
        'moduleType' => 'Multi-frame',
    ],
    [
        'ciodId' => 'enhanced-rt-image',
        'macroId' => 'rt-beam-limiting-device-opening-sequence',
        'usage' => 'C',
        'conditionalStatement' => 'Required if all Frames or the current Frame were acquired using a Beam Limiting Device.',
        'moduleType' => 'Multi-frame',
    ],
    [
        'ciodId' => 'enhanced-rt-image',
    ...
    [
        ...
        'macroId' => 'derivation-image',
        'usage' => 'C',
        'conditionalStatement' => 'Required if the image has been derived from another SOP Instance.',
        'moduleType' => 'Multi-frame',
    ],
    [
        'ciodId' => 'enhanced-continuous-rt-image',
    ...
    [
        ...
        'macroId' => 'rt-beam-limiting-device-opening-sequence',
        'usage' => 'C',
        'conditionalStatement' => 'Required if all Frames or the current Frame was acquired using a Beam Limiting Device.',
        'moduleType' => 'Multi-frame',
    ],
    [
        'ciodId' => 'enhanced-continuous-rt-image',
    ...
    [
        'ciodId' => 'photoacoustic-image',
        'macroId' => 'photoacoustic-excitation-characteristics',
        'usage' => 'U',
        'conditionalStatement' => null,
        'moduleType' => 'Multi-frame',
    ],
    [
        'ciodId' => 'photoacoustic-image',
        'macroId' => 'photoacoustic-image-frame-type',
        'usage' => 'M',
        'conditionalStatement' => null,
        'moduleType' => 'Multi-frame',
    ],
    [
        'ciodId' => 'photoacoustic-image',
        'macroId' => 'photoacoustic-image-data-type',
        'usage' => 'M',
        'conditionalStatement' => null,
        'moduleType' => 'Multi-frame',
    ],
    [
        'ciodId' => 'photoacoustic-image',
        'macroId' => 'photoacoustic-reconstruction-algorithm',
        'usage' => 'U',
        'conditionalStatement' => null,
        'moduleType' => 'Multi-frame',
    ],
    ...
    [
        'ciodId' => 'confocal-microscopy-image',
        'macroId' => 'confocal-microscopy-image-frame-type',
        'usage' => 'M',
        'conditionalStatement' => null,
        'moduleType' => 'Multi-frame',
    ],
